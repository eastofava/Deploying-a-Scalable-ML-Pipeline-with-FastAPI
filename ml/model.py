...
def performance_on_categorical_slice(
    ...
    specified by a column name and processes the data using
    one hot encoding for the categorical features and a
    label binarizer for the labels. This can be used in either
    ...
    """
    # Filtering the data slices
    data_slice = data[data[column_name] == slice_value]

    # Processing data slice
